...
export const getCharts = (range,type,id) => (dispatch, getState) => new Promise(async (resolve, reject) => {
  ...
  try {
    ...
    if(type === 'ph' || type === 'tds' || type === 't_lid'  || type === 'fillLevel' || type === 'maintanance' || type === 'abnormal' || type === 'phase_down' 
    || type === 'door_status' || type === 'force-motor' || type === 'motor' || type === 'alarm') {
...
console.log('update',data)
  ...
  //   });
  // }
  // if (data.motorRunningTime !== undefined && data.motorRunningTime !== null) {
  //   dispatch({
