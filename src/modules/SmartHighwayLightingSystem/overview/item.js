            ...
            style={{ alignSelf: 'flex-end', marginLeft: wp('1.5%') }}>
              {lights[index] === '2' ? (
                <TouchableOpacity style={[styles.btnView, { backgroundColor: 'transparent' }]} onPress={() => toggle()}>
                  <Icon3 name='toggle-on' color='green' size={22}></Icon3>
                </TouchableOpacity>
              ) : (
                  <TouchableOpacity style={[styles.btnView, { backgroundColor: 'transparent' }]} onPress={() => toggle()}>
                    <Icon3 name='toggle-on' color='red' size={22}></Icon3>
                  </TouchableOpacity>
                )}
            </View>
          )}
