...
import { getAlerts } from '../../../redux/actions/streetLightAction';
...
const AlertScreen = props => {
  ...
  const alert = useSelector(state => state.light.alerts);
  const AlertLoading = useSelector(state => state.light.alertLoading);
