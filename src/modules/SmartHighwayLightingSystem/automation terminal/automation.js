...
import { View, Text, StyleSheet, Alert, Animated, StatusBar, ImageBackground, ScrollView, TouchableOpacity, Platform } from 'react-native';
        ...
        <View style={styles.container}>
            <View
                ...
                <Dropdown
                    ...
                    style={{ width: wp('40%'), height: hp('4%'), marginTop: hp('1%'), borderWidth: 0.2 }}
                    color='#000'
                    items={segmentArray}
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    {(segment[selectedModule].allRoutines === true) && (segment[selectedModule].dim_high_routineEnable === true || segment[selectedModule].seg_routineEnable === true ||
                        segment[selectedModule].dim_medium_routineEnable === true || segment[selectedModule].dim_low_routineEnable === true) ? (
                            <TouchableOpacity style={{ height: 30, width: 60, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primary, marginRight: wp('-3%') }}
            ...
            {segmentLoading ? (
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    <Bubbles size={14} color={colors.primary} />
                </View>
            ) : (
                    <View style={{ flex: 1 }}>
                        <View style={{ flex: 0.9 }}>
                            ...
                            <Animatable.View animation="fadeIn" iterationCount={1}>
                                ...
                                <Card containerStyle={{ width: wp('35%'), height: hp('30%'), borderRadius: 30, marginLeft: wp('0%'), elevation: 1, padding: 0 }}>
                                    ...
                                    <Animatable.View animation="zoomInUp" iterationCount={1}>
                                    <Animatable.Text animation="bounce" iterationCount="1" easing="ease-out" 
                                    style={{ fontWeight: 'bold', fontSize: 30, color: '#000', alignSelf: 'center', marginTop: hp('3.5%') }}>{segment[selectedModule].light_time} sec</Animatable.Text>
                                    </Animatable.View>
                                </Card>
                                </Animatable.View>
                                    ...
                                    {(segment[selectedModule].allRoutines === true) && (segment[selectedModule].dim_high_routineEnable === true || segment[selectedModule].seg_routineEnable === true ||
                                        segment[selectedModule].dim_medium_routineEnable === true || segment[selectedModule].dim_low_routineEnable === true) ? (
                                            <TouchableOpacity style={[styles.IconView, {
                                                ...
                                                <Icon3 name='power-off' style={{
                                                    backgroundColor: 'grey', height: hp('7.5%'), width: wp('15%'), borderRadius: hp('5%')
                                                    , fontSize: hp('3.5%'), color: '#fff', paddingHorizontal: wp('4.5%'), paddingVertical: hp('2%')
                                                }}></Icon3>
                                            </TouchableOpacity>
                                            ...
                                            <TouchableOpacity style={[styles.IconView, {
                                                ...
                                                {segment[selectedModule].radar_enable === true ? (
                                                    <Icon3 name='power-off' style={{
                                                        backgroundColor: 'green', height: hp('7.5%'), width: wp('15%'), borderRadius: hp('5%')
                                                        , fontSize: hp('3.5%'), color: '#fff', paddingHorizontal: wp('4.5%'), paddingVertical: hp('2%')
                                                    }}></Icon3>
                                                ) : (
                                                        <Icon3 name='power-off' style={{
                                                            backgroundColor: 'red', height: hp('7.5%'), width: wp('15%'), borderRadius: hp('5%')
                                                            , fontSize: hp('3.5%'), color: '#fff', paddingHorizontal: wp('4.5%'), paddingVertical: hp('2%')
                                                        }}></Icon3>)}
                                            </TouchableOpacity>
                                        )}
                                    {segment[selectedModule].radar_enable === true ? (
                                        <Animatable.View animation="slideInDown" iterationCount={1}>
                                            <Animatable.Text animation="bounce" iterationCount="2" easing="ease-out"
                                             style={{ fontWeight: 'bold', fontSize: hp('3.5%'), color: '#000', alignSelf: 'center', marginTop: hp('4%') }}>ENABLED</Animatable.Text>
                                        </Animatable.View>
                                    ) : (
                                            <Animatable.View animation="slideInDown" iterationCount={1}>
                                                <Animatable.Text animation="bounce" iterationCount="2" easing="ease-out" 
                                                style={{ fontWeight: 'bold', fontSize: hp('3.5%'), color: '#000', alignSelf: 'center', marginTop: hp('4%') }}>DISABLED</Animatable.Text>
                                            </Animatable.View>
                                        )}
                                </Card>
                                </Animatable.View>
                                    ...
                                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        <View style={{ flexDirection: 'row' }}>
                                            ...
                                            {segment[selectedModule].segControl === '0' && segment[selectedModule].allRoutines === false ? (
                                                <TouchableOpacity style={{ height: 25, width: 60, borderRadius: 15, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center', marginRight: wp('-3%') }}
                                                    onPress={() => onPressDropdown('scheduling')}>
                                                    <Text style={{ color: '#fff' }}>Enable</Text>
                                                </TouchableOpacity>
                                            ) : segment[selectedModule].allRoutines === true ? (
                                                <TouchableOpacity style={{ height: 25, width: 60, borderRadius: 15, backgroundColor: "red", alignItems: 'center', justifyContent: 'center', marginRight: wp('-3%') }}
                                                    onPress={() => toggleScheduling()}>
                                                    <Text style={{ color: '#fff' }}>Disable</Text>
                                                </TouchableOpacity>
                                            ) : (
                                                        <TouchableOpacity style={{ height: 25, width: 60, borderRadius: 15, backgroundColor: "green", alignItems: 'center', justifyContent: 'center', marginRight: wp('-3%') }}
                                                            onPress={() => toggleScheduling()}>
                                                            <Text style={{ color: '#fff' }}>Enable </Text>
                                                        </TouchableOpacity>)}
                                        </View>
                            ...
                            <ScrollView style={{ paddingTop: 15 }} keyboardShouldPersistTaps="handled">
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                        ...
                                        <View>
                                            <View style={{ flexDirection: 'row', marginTop: wp('1%'), marginBottom: hp('1%') }}>
                                                ...
                                                <TouchableOpacity onPress={() => openTimePicker('segmentTo')}>
                                                    <Text style={{ marginLeft: wp('2%'), color: 'grey', fontSize: 14, borderBottomWidth: 0.5, borderColor: 'grey' }}>
                                                        {moment(segment[selectedModule].seg_endTime).format('HH:mm')}</Text>
                                                </TouchableOpacity>
                                                {ShowSegmentTo && (
                                                    <DateTimePicker
                                                        style={[styles.TimePicker, { marginLeft: wp('4%') }]}
                                    ...
                                    {segment[selectedModule].allRoutines === false ? (
                                        <TouchableOpacity onPress={() => onPressDropdown('segment')}
                                        ...
                                        <TouchableOpacity onPress={() => onClick_Routine('segment')}
                                            style={{ marginRight: wp('6%'), borderRadius: 10, width: wp('16%'), height: hp('4%'), backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ alignSelf: 'center', color: '#fff' }}>Disable</Text>
                                        </TouchableOpacity>
                                    ) : (
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <View style={{ flexDirection: 'column' }}>
                                        <View style={{ flexDirection: 'row' }}>
                                            ...
                                            <TouchableOpacity onPress={() => openTimePicker('dimHighFrom')}>
                                                <Text style={{ marginLeft: wp('2%'), color: 'grey', fontSize: 14, borderBottomWidth: 0.5, borderColor: 'grey' }}>
                                                    {moment(segment[selectedModule].dim_high_strtime).format('HH:mm')}</Text>
                                            </TouchableOpacity>
                                            {Show_Dim_High_From && (
                                                <DateTimePicker
                                                    style={[styles.TimePicker, { marginLeft: wp('4%') }]}
                                        ...
                                        <View>
                                            <View style={{ flexDirection: 'row', marginBottom: hp('1%') }}>
                                                ...
                                                <TouchableOpacity onPress={() => openTimePicker('dimHighTo')}>
                                                    <Text style={{ marginLeft: wp('2%'), color: 'grey', fontSize: 14, borderBottomWidth: 0.5, borderColor: 'grey' }}>
                                                        {moment(segment[selectedModule].dim_high_endtime).format('HH:mm')}</Text>
                                                </TouchableOpacity>
                                                {Show_Dim_High_To && (
                                                    <DateTimePicker
                                                        style={[styles.TimePicker, { marginLeft: wp('4%') }]}
                                    ...
                                    {segment[selectedModule].allRoutines === false ? (
                                        <TouchableOpacity onPress={() => onPressDropdown('dimHigh')}
                                            style={{ marginRight: wp('6%'), borderRadius: 10, width: wp('16%'), height: hp('4%'), backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ alignSelf: 'center', color: '#fff' }}>Disable</Text>
                                        </TouchableOpacity>
                                    ) : segment[selectedModule].dim_high_routineEnable === true ? (
                                        <TouchableOpacity onPress={() => onClick_Routine('dimHigh')}
                                            style={{ marginRight: wp('6%'), borderRadius: 10, width: wp('16%'), height: hp('4%'), backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ alignSelf: 'center', color: '#fff' }}>Disable</Text>
                                        </TouchableOpacity>
                                    ) : (
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <View style={{ flexDirection: 'column' }}>
                                        <View style={{ flexDirection: 'row' }}>
                                            ...
                                            <TouchableOpacity onPress={() => openTimePicker('dimMediumFrom')}>
                                                <Text style={{ marginLeft: wp('2%'), color: 'grey', fontSize: 14, borderBottomWidth: 0.5, borderColor: 'grey' }}>
                                                    {moment(segment[selectedModule].dim_medium_strtime).format('HH:mm')}</Text>
                                            </TouchableOpacity>
                                        ...
                                        <View>
                                            <View style={{ flexDirection: 'row', marginBottom: hp('1%') }}>
                                                ...
                                                <TouchableOpacity onPress={() => openTimePicker('dimMediumTo')}>
                                                    <Text style={{ marginLeft: wp('2%'), color: 'grey', fontSize: 14, borderBottomWidth: 0.5, borderColor: 'grey' }}>
                                                        {moment(segment[selectedModule].dim_medium_endtime).format('HH:mm')}</Text>
                                                </TouchableOpacity>
                                                {Show_Dim_Medium_To && (
                                                    <DateTimePicker
                                                        style={[styles.TimePicker, { marginLeft: wp('4%') }]}
                                    ...
                                    {segment[selectedModule].allRoutines === false ? (
                                        <TouchableOpacity onPress={() => onPressDropdown('dimMedium')}
                                            style={{ marginRight: wp('6%'), borderRadius: 10, width: wp('16%'), height: hp('4%'), backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ alignSelf: 'center', color: '#fff' }}>Disable</Text>
                                        </TouchableOpacity>
                                    ) : segment[selectedModule].dim_medium_routineEnable === true ? (
                                        <TouchableOpacity onPress={() => onClick_Routine('dimMedium')}
                                            style={{ marginRight: wp('6%'), borderRadius: 10, width: wp('16%'), height: hp('4%'), backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ alignSelf: 'center', color: '#fff' }}>Disable</Text>
                                        </TouchableOpacity>
                                    ) : (
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <View style={{ flexDirection: 'column' }}>
                                        <View style={{ flexDirection: 'row' }}>
                                            ...
                                            <TouchableOpacity onPress={() => openTimePicker('dimLowFrom')}>
                                                <Text style={{ marginLeft: wp('2%'), color: 'grey', fontSize: 14, borderBottomWidth: 0.5, borderColor: 'grey' }}>
                                                    {moment(segment[selectedModule].dim_low_strtime).format('HH:mm')}</Text>
                                            </TouchableOpacity>
                                            {Show_Dim_Low_From && (
                                                <DateTimePicker
                                                    style={[styles.TimePicker, { marginLeft: wp('4%') }]}
                                        ...
                                        <View>
                                            <View style={{ flexDirection: 'row', marginBottom: hp('1%') }}>
                                                ...
                                                <TouchableOpacity onPress={() => openTimePicker('dimLowTo')}
                                                    style={{ marginBottom: wp('2%') }}>
                                                    <Text style={{ marginLeft: wp('2%'), color: 'grey', fontSize: 14, borderBottomWidth: 0.5, borderColor: 'grey' }}>
                                                        {moment(segment[selectedModule].dim_low_endtime).format('HH:mm')}</Text>
                                                </TouchableOpacity>
                                                {Show_Dim_Low_To && (
                                                    <DateTimePicker
                                                        style={[styles.TimePicker, { marginLeft: wp('4%') }]}
                                    ...
                                    {segment[selectedModule].allRoutines === false ? (
                                        <TouchableOpacity onPress={() => onPressDropdown('dimLow')}
                                            style={{ marginRight: wp('6%'), borderRadius: 10, width: wp('16%'), height: hp('4%'), backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ alignSelf: 'center', color: '#fff' }}>Disable</Text>
                                        </TouchableOpacity>
                                    ) : segment[selectedModule].dim_low_routineEnable === true ? (
                                        <TouchableOpacity onPress={() => onClick_Routine('dimLow')}
                                            style={{ marginRight: wp('6%'), borderRadius: 10, width: wp('16%'), height: hp('4%'), backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ alignSelf: 'center', color: '#fff' }}>Disable</Text>
                                        </TouchableOpacity>
                                    ) : (
