    ...
    return (
      <View style={{flex:1}}>
        <ScrollView style={{flex:1}}>
          <Card containerStyle={{ backgroundColor: '#fff', borderRadius: 30,elevation: 1,width:wp('87%'),height:hp('15%')}}>
            ...
            type === 'Segment Control Logs' ? (
              ...
              <LinearGradient colors={["#0575e6", "#0b5eca", "#0b47af", "#083194", "#021b79"]}
                style={{ height: hp('8.5%'), width: wp('16.5%'), backgroundColor: '#00008B', borderRadius:32, justifyContent: 'center',alignSelf:'center' }}>
                <Icon
                  name="list-alt"
