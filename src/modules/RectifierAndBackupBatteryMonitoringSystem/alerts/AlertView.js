...
import { getAlerts } from '../../../redux/actions/rectifierAction';
...
const AlertScreen = props => {
  ...
  const alert = useSelector(state => state.rectifier.alerts);
  const AlertLoading = useSelector(state => state.rectifier.alertLoading);
