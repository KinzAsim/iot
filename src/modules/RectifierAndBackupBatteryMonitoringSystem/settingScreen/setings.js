    ...
    return (
        <View>
            ...
            <ScrollView keyboardShouldPersistTaps="handled">
                <Card containerStyle={{ width: wp('85%'), height: hp('75%'), borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 0, alignSelf: 'center'}}>
                    ...
                    <Card containerStyle={styles.cards}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            <View style={[styles.IconView, { height: hp('7.5%'), width: wp('14%'), backgroundColor: '#fff', marginTop: hp('-2%') }]}>
                ...
                <Card containerStyle={{ width: wp('85%'), height: hp('53%'), borderTopLeftRadius: 30, marginTop:hp('5%'),marginBottom:hp('10%'),
...
const styles = StyleSheet.create({
    ...
    cards: { width: wp('76%'), height: hp('13%') },
