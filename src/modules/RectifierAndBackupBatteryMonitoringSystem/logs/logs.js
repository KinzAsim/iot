                        ...
                        {logs.length > 0 ? (
                            <View style={{ backgroundColor: '#fff', marginHorizontal: wp('3%'), marginVertical: hp('0.5%'), paddingBottom: hp('12%') }}>
                                <FlatList
                                    data={logs}
                                    renderItem={({ item }) =>
                                        <Item status={item.status} end={item.end} start={item.start} duration={item.duration} dc_inputVoltage={item.dc_inputVoltage}
                                            createdAt={item.createdAt} ac_voltage={item.ac_voltage} battery_voltagePercentage={item.battery_voltagePercentage}
                                            battery_voltage={item.battery_voltage} type={selectedTypeValue} />}
...
const styles = StyleSheet.create({
    ...
    Dropdown: { width: wp('35%'), height: hp('4%'), marginTop: hp('1.5%'), marginLeft: wp('0.1%'), padding: 0 },
    Dropdown1: { width: wp('65%'), height: hp('4%'), marginTop: hp('1.5%'), marginLeft: wp('0.5%'), paddingRight: 5, marginRight: wp('4%') },
})