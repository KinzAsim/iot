                            ...
                            <Animatable.View ref={this.handleViewRef1}>
                                <Card containerStyle={[styles.cardStyle, { width: wp('80%'), height: hp('15%'), borderTopEndRadius: 30, borderBottomRightRadius: 30, marginLeft: wp('-2%') }]}>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                        ...
                                        <View style={[styles.IconView, { height: hp('7.5%'), width: wp('14%'), backgroundColor: '#fff', marginTop: hp('1%') }]}>
                            ...
                            <Animatable.View ref={this.handleViewRef2}>
                                <Card containerStyle={[styles.cardStyle, { width: wp('80%'), height: hp('15%'), borderTopStartRadius: 30, borderBottomStartRadius: 30, marginLeft: wp('20%') }]}>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                        ...
                                        <View style={[styles.IconView, { height: hp('7.5%'), width: wp('14%'), backgroundColor: '#fff', marginTop: hp('1%') }]}>
                                            <Image source={image} style={{ alignSelf: 'center', marginTop: hp('3%'), width: wp('11%'), height: hp('9%'), color: 'red' }} />
                                        </View>
                                    </View>
                                </Card>
                            </Animatable.View>
                            ...
                            <Animatable.View ref={this.handleViewRef3}>
                                <Card containerStyle={[styles.cardStyle, { width: wp('80%'), height: hp('15%'), borderTopEndRadius: 30, borderBottomRightRadius: 30, marginLeft: wp('-2%') }]}>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                        ...
                                        <View style={[styles.IconView, { height: hp('7.5%'), width: wp('14%'), backgroundColor: '#6d2aa8', marginTop: hp('1%') }]}>
                                            <Icon1 name="thermometer-lines" size={30} color={'#fff'} />
                                        </View>
                            ...
                            <Animatable.View ref={this.handleViewRef5}>
                                <Card containerStyle={[styles.cardStyle, { width: wp('80%'), height: hp('15%'), borderTopEndRadius: 30, borderBottomRightRadius: 30, marginLeft: wp('-2%') }]}>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                        ...
                                        <View style={[styles.IconView, { height: hp('7.5%'), width: wp('14%'), backgroundColor: '#6a0dad', marginTop: hp('1%') }]}>
                                            <Image source={iconThreshold} style={{ alignSelf: 'center', width: wp('8%'), height: hp('5%') }} />
                                        </View>
                                    </View>
