...
import { getAlerts } from '../../../redux/actions/humidity';
...
const AlertScreen = props => {
  ...
  const alert = useSelector(state => state.humidity.alerts);
  const AlertLoading = useSelector(state => state.humidity.alertLoading);
